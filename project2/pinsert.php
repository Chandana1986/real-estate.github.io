...
if(isset($_SESSION['admin_id']) && isset($_POST['submit'])){    
  ...
  $images = "project2/".$_FILES['images']['name'];
...
if($conn->connect_error)
  ...
  $sql= "INSERT INTO property(admin_id,seller_name,city,type_of_property,no_of_bedroom,no_of_bathroom,other_rooms,balconies,parking,total_no_of_floor,floor_no,availability_status,age_of_property,MobileNo,SIZE_OF_PROPERTY,COST_OF_THE_PROPERTY,images,special_prop1) values ('" .  $admin_id. "','" . $seller_name . "','" . $city . "','" . $type_of_property . "','" . $no_of_bedroom . "','" .$no_of_bathroom . "','" .$other_rooms . "','" .$balconies . "','" .$parking . "','" .$total_no_of_floor . "','" .$floor_no . "','" .$availability_status . "','" .$age_of_property . "','" .$MobileNo . "','" .$SIZE_OF_PROPERTY . "','" .$COST_OF_THE_PROPERTY . "','" .$images. "','" .$special_prop1. "')";
